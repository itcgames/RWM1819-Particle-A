...
var emitters = [new Emitter(new Vector(800, 530), Vector.fromAngle(-10.5, 10), 10 ,'rgb(0,255,255)'),
   new Emitter(new Vector(900, 530), Vector.fromAngle(-5.5, 5), 10 ,'rgb(255,0,255)'),
